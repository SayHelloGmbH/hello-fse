...
class Gutenberg
{
	...
	public function __construct()
	{
		...
		if (file_exists($this->theme_path . '/assets/fonts/woff2.css')) {
			$this->admin_font_path = $this->theme_path . '/assets/fonts/woff2.css';
			$this->admin_font_url = $this->theme_url . '/assets/fonts/woff2.css';
		}
	}
	...
	public function enqueueBlockAssets()
	{
		...
		if ($this->admin_font_url) {
			wp_enqueue_style('sht-gutenberg-font', $this->admin_font_url, [], filemtime($this->admin_font_path));
		}
	}
